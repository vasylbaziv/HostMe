...
<body>
    ...
    <div class="container" style="text-align: justify;">
        ...
        <div class="col-md-8 col-md-offset-2" id="article1"
            ...
            <h1>
                <small>Hosting tips</small>
            </h1>
            <ul>
                <li>Read the traveller's profile carefully</li>
                <li>Be clear about your expectations and house
                    rules</li>
                <li>Open your home to travellers and share your
                    life</li>
            </ul>
        </div>

...
function print_country(country_id) {
    // given the id of the <select> tag as function argument, it inse
    //
    // rts <option> tags
...
//function search_country(countryId, country_user) {
//    var option_str = document.getElementById(countryId);
//    if (country_user.match("") || country_user.empty || country_user.match(" ")) {
//        var x, i = 0;
//        for (x in country_arr) {
//            option_str.options[i++] = new Option(country_arr[x], country_arr[x]);
//        }
...
//            if (country_arr[j].match(country_user)) {
//                var y;
//                j = j - 1;
//                for (y in country_arr) {
//                    option_str.options[j++] = new Option(country_arr[y], country_arr[y]);
//                }
//            }
//        }
//    }

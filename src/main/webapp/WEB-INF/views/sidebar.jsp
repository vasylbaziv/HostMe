...
-				</security:authorize>
	...
	<li class="treeview"><a href="#"> <i class="fa fa-edit"></i> <span>Forms</span>
		...
		<ul class="treeview-menu">
			...
			<li><a href="../forms/advanced.html" style="margin-left: 10px;"><i
	...
	<li class="treeview"><a href="#"> <i class="fa fa-folder"></i>
		...
		<ul class="treeview-menu">
			<li><a href="../examples/invoice.html"
				style="margin-left: 10px;"><i class="fa fa-angle-double-right"></i>
					Invoice</a></li>
			<li><a href="../examples/login.html" style="margin-left: 10px;"><i
			...
			<li><a href="../examples/blank.html" style="margin-left: 10px;"><i

...
<!-- 								</div> -->
								...
								<div class="row">
									<div class="col-md-3">
										<spring:message code="label.hoster" />
										:
									</div>
								...
								<div id="UL" class="row">
									...
									<div class="col-md-9">
										<c:forEach items="${hosting.owner.languages}" var="languages"
											varStatus="loop">
								...
								<div class="row">
									<div class="col-md-3">
										<spring:message code="label.guestsNumber" />
										:
									</div>
								...
								<div class="row">
									<div class="col-md-3">
										<spring:message code="label.guestsType" />
										:
									</div>
									<div class="col-md-8">
										<c:choose>
											<c:when test="${hosting.gender == 'MALE'}">Men</c:when>
											<c:when test="${hosting.gender == 'FEMALE'}">Women</c:when>
											<c:when test="${hosting.gender == 'UNSPECIFIED'}">Men, women</c:when>
										</c:choose>
								...
								<div class="row">
									<div class="col-md-3">
										<spring:message code="label.smoking" />
										:
									</div>
									<div class="col-md-8">
										<c:choose>
											<c:when test="${hosting.smoking == '0'}">Not allowed</c:when>
							...
							<div class="col-md-4" style="margin-top: 1em;">
								...
								<div style="padding-bottom: 0.5em"
									...
									<input id="disabledDate" type="hidden" value="${disabledDate}" />
									<input id="dateNew" type="hidden" value="${dateNew}" />
									<h4>
										<spring:message code="label.findGuestReviews" />
										<a
											href="<c:url value="feedbacks?hostingId=${hosting.hostingId}" />">
											<spring:message code="label.here" />
										</a>
									</h4>

								</div>

								<form:form action="feedbacks-send" method="post"
									modelAttribute="feedback" id="send_feedback_form">
									<div class="panel box box-warning">
										<div class="box-header">
											<h5 class="box-title">
												<a data-toggle="collapse" data-parent="#accordion"
													href="#collapseFeedbacks" class="collapsed"> <spring:message
										...
										<div style="margin-left: 0.7em">
											<spring:message code="label.sendUs" />
											<a data-toggle="collapse" data-parent="#accordion"
												href="#collapseFeedbacks"> <spring:message
										...
										<div class="box-body">
											...
											<div id="collapseFeedbacks" class="panel-collapse collapse"
												style="height: 0px;">
												<div class="form-group" style="margin-bottom: 0">
													<spring:message code="label.stayOpinion"
														var="varStayOption" />
													<form:textarea id="description" path="description"
														class=" form-control" placeholder="${varStayOption}"
														style="margin-bottom:1em"></form:textarea>
													<button class="btn btn-warning"
														<c:if test="${hosting.owner.userId eq loggedUser.userId}">
                                                    <c:out value="disabled='disabled'"/>
                                                    </c:if>>
														<spring:message code="label.sendFeedbackButton" />
													</button>
												</div>
											</div>
										</div>
					...
					<div class="row">
						<div class="col-md-12">
							<form:form action="request" method="post"
								modelAttribute="request" id="send_request_form">
								<div class="col-md-12">
										...
										<div class="col-md-4">
											<div class="panel box box-info">
												<div class="box-header">
													<h4 class="box-title">
														<a data-toggle="collapse" data-parent="#accordion"
															href="#collapseCalendar" class="collapsed"> <spring:message
														...
														<div class="form-group">
															...
															<div class="input-group">
																...
																<input name="timeRange" type="text"
																	class="form-control pull-right" id="reservationtime" />
																<form:input path="endDate" type="hidden" id="endDate" />
																<form:input path="beginDate" type="hidden"
																	id="beginDate" />
																<form:input path="hosting" value="${hosting.hostingId}"
																	type="hidden" id="hosting" />
															</div>
															<!-- /.input group -->
														</div>
													</div>
									...
									<div class="row">
										<div class="col-md-1">
											...
											<button onfocus="formDate()" class="btn btn-primary">
												<spring:message code="label.sendRequest" />
											</button>
	...
	<script>
		...
		$(function() {
			$('#available div').datepicker(
					{
						dateFormat : 'dd-mm-yyyy',
						beforeShowDay : function(date) {
							if ($.inArray(date.getFullYear() + '-'
									+ (date.getMonth() + 1) + '-'
									+ date.getDate(), dateDisabled) !== -1) {
								return false;
							}
							return true;
						}

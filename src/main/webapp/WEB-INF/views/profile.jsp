                ...
                <div class="box-body">
                    ...
                    <div>
                        <br /> <br /> <a
                            ...
                            class="btn btn-danger"> Edit Profile</a> <a
                            class="btn" href="#myModal"
                            data-toggle="modal">Change PW</a>
                    </div>
                        ...
                        <div class="box-body">
                            <dl class="dl-horizontal">
                                ...
                                <dd>
                                    <c:choose>
                                        <c:when
                                            test="${user.gender == 'FEMALE'}">female</c:when>
                                        <c:when
                                            test="${user.gender == 'MALE'}">male</c:when>
                                    </c:choose>
                                </dd>
                                <dt>login</dt>
                                <dd>${user.login}</dd>
                    ...
                    <c:if test="${!empty user.hostings}">
                        ...
                        <table id="example2"
                            ...
                            <tbody>
                                ...
                                <c:forEach items="${user.hostings}"
                                    var="hostings" varStatus="loop">
                                    <c:set var="count"
                                        value="${count+1}" />
                                    <tr>
                                        <td>${count}</td>

...
<body>
	...
	<form:form method="post" action="registration" modelAttribute="user"
			...
			<div class="form-group">
				...
				<div class="col-lg-1">
					<div class="input-group">
						<label for="female" class="col-sm-1 col-sm-offset-1 control-label">
							Female</label> <span class="input-group-addon"> <form:radiobutton
		...
		<div class="row">
			<div class="form-group">
				<label for="password" class="col-sm-2 col-sm-offset-1 control-label"><h4>Password</h4>
				</label>
				<div class="col-sm-5">

...
<body>
	...
	<section class="content">
						...
						<div class="checkbox_cnt">
							...
							<div class="radio">
								<label> <input type="radio" name="optionsRadios"
									id="female" value="FEMALE"> Only women
								</label>
							</div>
							<div class="radio">
								<label> <input type="radio" name="optionsRadios"
									id="male" value="MALE"> Only men
								</label>
							</div>
							<div class="radio">
								<label> <input type="radio" name="optionsRadios"
									id="optionsRadios3" value="UNSPECIFIED" checked="checked">
									Both
								</label>
							</div>
							<div class="checkboxes">
								<div class="left" style="float: right; width: 77%">
									<div class="checkbox">
										<input type="checkbox" id="children"> <label>Children</label>
									</div>
									<div class="checkbox">
										<input type="checkbox" id="family"> <label>Family</label>
									</div>
								</div>
								<div class="right" style="float: left; width: 23%">
									<div class="checkbox">
										<input type="checkbox" id="pets"> <label>Pets</label>
									</div>
									<div class="checkbox">
										<input type="checkbox" id="smoking"> <label>Smoking</label>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row" style="float: right; width: 35%">
								<div class="select">
									<select class="select" id="country"
										...
										<option></option>
									</select> <br> <select class="select" id="region"
										style="margin: 10px 0; width: 100px; height: 25px">
										<option></option>
									</select> <br> <select class="select" id="count"
		...
		<div class="pagination inline" id="pagination">
			<form id="myFormPagePrevious" method="get" action="searchhosts"
				style="display: inline">
				<input type="submit" id="previousPage" value="&laquo Previous page"
					style="display: none" />
			</form>
			<form id="myFormPageNext" method="get" action="searchhosts"
				style="display: inline">

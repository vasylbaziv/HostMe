...
public class SearchController {
    ...
    public String searchAll(@RequestParam("country") String country,
        ...
        map.put("host", new Hosting());
        map.put("hostsList", searchService.getList(srchcountry, srchregion, srchpets,
                srchchildren, srchsmoking, srchfamily, srchMinCount, srchMaxCount));
        return "search";
    }
